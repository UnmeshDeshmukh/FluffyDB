 ...
 *
 */
public class ImageInit extends ChannelInitializer<SocketChannel> {
	...
	public void initChannel(SocketChannel ch) throws Exception {
		...
		pipeline.addLast("protobufDecoder", new ProtobufDecoder(ImageTransfer.ImageMsg.getDefaultInstance()));
